...
import 'package:yoyo_school_app/config/utils/local_notification_services.dart';
...
class AppInitializer {
  static Future<void> initialize() async {
    ...
    final localNotificationServices = LocalNotificationsService.instance();
    await localNotificationServices.init();
    final firebaseMessagingService = FirebaseMessagingService.instance();
    firebaseMessagingService.init(
      localNotificationsService: localNotificationServices,
    );
